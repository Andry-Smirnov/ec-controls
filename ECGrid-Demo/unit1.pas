...
uses
  ...
  LCLProc, Spin, ECGrid, ECEditBtns, FGL;
...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure ECGrid2Selection(Sender: TObject; ACol, ARow: Integer);
...
procedure TForm1.ECGrid2Selection(Sender: TObject; ACol, ARow: Integer);
begin
  //DebugLn('OnSelection ', intToStr(ACol), ' ', intToStr(ARow));
end;
